<div class="navbar bg-base-100">
  <div class="flex-1">
    <a class="btn btn-ghost normal-case text-xl" href="/">DarmApp</a>
  </div>
</div>
...
-215 71 -398 87 -598 52z"
      ...
      <h1 class="text-5xl font-bold">Darma</h1>
      <p class="py-2">Proyecto Final - Fundamentos de Ingenieria Material</p>
      <p class="py-2">Mario Alejandro Ruiz</p>
      <p class="py-2">Nicolas Correal</p>
